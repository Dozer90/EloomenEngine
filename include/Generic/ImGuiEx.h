...
namespace Piviots {
static constexpr ImVec2 TopLeft = ImVec2(0.0f, 0.0f);
static constexpr ImVec2 Top = ImVec2(0.5f, 0.0f);
static constexpr ImVec2 TopRight = ImVec2(1.0f, 0.0f);
static constexpr ImVec2 Left = ImVec2(0.0f, 0.5f);
static constexpr ImVec2 Middle = ImVec2(0.5f, 0.5f);
static constexpr ImVec2 Right = ImVec2(1.0f, 0.5f);
static constexpr ImVec2 BottomLeft = ImVec2(0.0f, 1.0f);
static constexpr ImVec2 Bottom = ImVec2(0.5f, 1.0f);
static constexpr ImVec2 BottomRight = ImVec2(1.0f, 1.0f);
}

struct Transform {
    ImVec2 mPiviot = Piviots::TopLeft;
    ImVec2 mPosition = ImVec2(0.0f, 0.0f);
    ImVec2 mScale = ImVec2(1.0f, 1.0f);
